      ...
      <div class="box-body">
        <div class="row">
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control pull-right" id="reservationtime" name="duration"
          ...
          <div class="col-md-4">
            ...
            <div class="input-group">
              <button type="button" class="btn btn-default pull-right" id="daterange-btn" name="season"   required="">
                <span>
                  <i class="fa fa-calendar"></i>      Select Season or event
                </span>
