    ...
    <section class="content w-full">
        <div class="container">
            ...
            <div class="box box-info">
                ...
                <form action="{{ route('clubs.register') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="club_name" id="club_name" placeholder="Club Name" required>
                                </div>
                            </div>
