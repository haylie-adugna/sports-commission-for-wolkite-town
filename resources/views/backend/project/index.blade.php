      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body table-responsive">
            <a href="{{ route('project.create') }}" class="btn btn-success mb-3"><i class="fa fa-plus"></i>Add New project</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        N/A
                                    @endif
                                </td>                                        <td>{{ $project->contact_information }}</td>
                                ...
                                <td><img style="height: 100px; width: 100px;" src="{{asset('upload/project/image')}}/{{$project->logo}}" alt="logo"></td>
                                    ...
                                    <div class="fa fa-edit">
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu pull-right" role="menu">
                                                ...
                                                <i class="divider"></i>
                                                {{--Delete--}}
                                                <a id="" href="{{ route('project.destroy', $project->id) }}"
