...
<div class="widget-body mb-3"> <div class="widget-vs"> <div class="team-1"> @foreach(DB::table('matchs') ->select('matchs.id', 'matchs.Team1', 'clubs.club_name') ->leftJoin('clubs', 'matchs.Team1', '=', 'clubs.id') ->groupBy('matchs.Team1', 'matchs.id', 'clubs.club_name') ->get() as $match) <img src="{{ asset('assets/images/logo.png') }}" alt="Image" class="img-circle elevation-2"> <h3 value="{{ $match->id }}">{{ $match->club_name }}</h3> @endforeach </div> <div class="vs"> <span><span>VS</span></span> </div> <div class="team-2"> @foreach(DB::table('matchs') ->select('matchs.id', 'matchs.Team2', 'clubs.club_name') ->leftJoin('clubs', 'matchs.Team2', '=', 'clubs.id') ->groupBy('matchs.Team2', 'matchs.id', 'clubs.club_name') ->get() as $match) <img src="{{ asset('assets/images/logo.png') }}" alt="Image" class="img-circle elevation-2"> <h3 value="{{ $match->id }}">{{ $match->club_name }}</h3> @endforeach </div> </div> </div>
