                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <input type="password" class="form-control @error('password') is-invalid @enderror"
                            placeholder="Password" name="password" value="1234567" required autocomplete="current-password">
                        @error('password')
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4 pull-left">
                            ...
                            <input class="form-check-input bg-black" type="checkbox" name="remember" id="remember"
